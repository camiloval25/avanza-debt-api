export const paymentReceiptHtml = (receipt) => {
  ...
  const paymentReceipt = `<!DOCTYPE html>
  <html lang="en">
    <head>
      <meta charset="UTF-8" />
        ...
        <thead>
          <tr>
            ...
            <th class="tg-c3ow" colspan="2">
              ...
              <br />
              <span style="font-weight: bold">TESORERÍA</span>
              <br />Consecutivo: 1-00001
            </th>
            <th class="tg-c3ow" colspan="2">
              <span style="font-weight: bold">NIT: 901.500.148-5</span
              ><br />Personería Jurídica<br />Resolución: 2021060090546<br />Carrera
              51 Nro. 49-07 Piso 2<br />
              <span style="font-weight: bold">Celular: 314 596 3000</span>
            </th>
          </tr>
          <tr>
            <th class="tg-0pky">Código: F-GF-01</th>
            <th class="tg-0pky">Versión: 1 - 1/09/2021</th>
        ...
        <tbody>
          <tr>
            ...
            <td class="tg-c3ow" colspan="2">
              Curso y/o seminario a matricular:<br />
              <span style="font-weight: bold">${courseName}</span
              >
            </td>
            <td class="tg-0pky">
              <span style="font-weight: bold">Jornada:</span><br />Semana
            </td>
            <td class="tg-c3ow">
          ...
          <tr>
            ...
            <td class="tg-c3ow">
              <span style="font-weight: bold">No. Documento:</span>
              <br />
              ${studentIdentification}
            </td>
            <td class="tg-c3ow">
            ...
            <td class="tg-c3ow" colspan="2">
              <span style="font-weight: bold">Teléfono:</span><br />000 00 00
            </td>
          </tr>
          <tr>
            <td class="tg-baqh" colspan="5">
              <span style="font-weight: bold">REGISTRO DE PAGO</span>
            </td>
          </tr>
          <tr>
            <td class="tg-0lax">
              <span style="font-weight: bold !important">Valor del Curso: </span>
              <br />
              $${coursePrice}
              <br />
            ...
            <td class="tg-baqh">
              <span style="font-weight: bold">En letras valor pagado:</span>
              <br />
              $${payHistoryAmount}
              <br />Un Milan trescientos mil pesos
            </td>
            <td class="tg-baqh" colspan="2">
              <span style="font-weight: bold">Firma y sello Academia Avanza</span>
            </td>
            <td class="tg-baqh">
              <span style="font-weight: bold">Reg: </span><br />01-231
            </td>
          </tr>
        </tbody>
      </table>
